<section class="mb-[60px] sm:mb-[80px] xl:mb-[120px]">
    ...
    <div class="flex flex-col gap-[25px] items-center md:flex-row">
        ...
        <img src="{{ asset('images/about-me-image.jpg') }}" alt="Фото блока 'Обо мне'" class="block w-full sm:w-[300px] lg:w-[440px] xl:w-[550px]">
    </div>
</section>